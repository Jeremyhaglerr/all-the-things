...
import JeremyThings from './pages/JeremyThings/JeremyThings'
...
const App = () => {
  ...
  const [eitansThings, setEitansThings] = useState([
    {
      name: 'chicken',
      image:
  ...
  return (
    <Routes>
      ...
      <Route
        ...
        element={<ManliestThings things={eitansThings} />}
      />
      <Route
      ...
      />
      <Route 
      path="/the-jeremy-things"
      element={<JeremyThings things={jeremysThings}/>}
      />
    </Routes>
  )
}
